...
import { Home, Activity, HotSale, Mine, GoodDetail, NotFound, HotDetail, Cars, Login } from './components/pages'
...
const routes = [
  ...
  {id: 9, path: '/login', component: Login}
...
class App extends Component {
  ...
  hasNavBar () {
      ...
      let unneed = [ '/good-detail', '/not-found', '/hot-detail', '/login' ]
